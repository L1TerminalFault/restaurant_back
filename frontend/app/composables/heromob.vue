...
<template><!-- Hero Section -->
  <section class="min-h-[95vh] items-center justify-center">
    ...
    <div class="mx-auto items-center text-center justify-center">
      ...
      <div class="relative py-6 justify-center items-center mx-auto">
        ...
        <div class="absolute left-8 top-1/2 z-20 items-center space-x-3 bg-obsidian-900/90 border border-brand-500/30 px-4 py-3 rounded-2xl shadow-2xl backdrop-blur-md animate-float">
          ...
          <div class="text-left">
            <p class="text-[9px] font-black text-zinc-400 uppercase tracking-wider">Zero Printing Cost</p>
            <p class="text-xs font-black text-white uppercase">Instant Updates</p>
          </div>
        </div>

        <!-- Floating Accent Label - Right -->
        <div class="absolute right-10 top-1/3 z-20 items-center space-x-3 bg-obsidian-900/90 border border-amber-500/30 px-4 py-3 rounded-2xl shadow-2xl backdrop-blur-md animate-float-delayed">
          <div class="w-3 h-3 rounded-full bg-amber-400"></div>
          <div class="text-left">
            <p class="text-[9px] font-black text-zinc-400 uppercase tracking-wider">Better Sales</p>
            <p class="text-xs font-black text-white uppercase">+22% Avg. Orders</p>
          </div>
        </div>
      ...
      <section class="text-2xl font-black text-brand-400 tracking-tight mt-20 mb-4 px-3 max-w-xl mx-auto">
          <div class="grid grid-cols-4 gap-1">
            ...
            <div class="text-center sm:text-left sm:pl-4">
              <div class=" text-white">42%</div>
              <p class="text-[9px] text-zinc-400 uppercase tracking-widest font-extrabold">Increase <br/> in Reach</p>
            </div>

            <div class="text-center sm:text-left sm:pl-8">
              <div class=" text-brand-400">100%</div>
              <p class="text-[9px] text-zinc-400 uppercase tracking-widest font-extrabold">Uptime  <br/>Guarantee</p>
            </div>

            <div class="text-center sm:text-left sm:pl-8">
              <div class=" text-amber-400">#1 </div>
              <p class="text-[9px] text-zinc-400 uppercase tracking-widest font-extrabold">Search  <br/>Discovery</p>
            </div>
            <div class="">
              <div class=" text-white">30%</div>
              <p class="text-[9px] text-zinc-400 uppercase tracking-widest font-extrabold">More Repeat  <br/>Visits</p>
            </div>
